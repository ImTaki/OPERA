...
SELECT * FROM ngsfr_subr_bom WHERE bom_parent_item = 'P18351486'

SELECT * FROM item WHERE item_id = 'C0000007242'
...
SELECT Top 100 * FROM OPERA_vw_FCS -- WHERE line_name = 'H2FCS904';

SELECT top 1 ent_id FROM ent WHERE ent_name='T2BH0205'
...
SELECT * FROM bom_item WHERE parent_item_id = 'C0000007162'
...
-- BOM
SELECT * FROM bom_item WHERE parent_item_id = 'C0000007315'

SELECT * FROM ngsfr_subr_bom WHERE bom_parent_item = 'C0000007162' -- intf_process_status = 1
...
SELECT * From job_exec WHERE cur_wo_id = '000102087677'
